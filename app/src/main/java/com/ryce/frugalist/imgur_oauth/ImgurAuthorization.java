package com.ryce.frugalist.imgur_oauth;
...
//    }
    ...
    public String requestNewAccessToken() {
        ...
        try {
            ...
            nvps.put("refresh_token", refreshToken);
            nvps.put("client_id", MyAppConstants.MY_IMGUR_CLIENT_ID);
            nvps.put("client_secret", MyAppConstants.MY_IMGUR_CLIENT_SECRET);
            nvps.put("grant_type", "refresh_token");

            OutputStream out = conn.getOutputStream();
            BufferedWriter writer = new BufferedWriter(
                    new OutputStreamWriter(out, "UTF-8"));
            writer.write(getPostDataString(nvps));
